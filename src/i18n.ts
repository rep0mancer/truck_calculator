...
export const translations = {
  ...
  en: {
    title: 'Loading Space Calculator', subtitle: 'European-standard pallet placement visualization', truckType: 'Vehicle type:', reset: 'Reset all',
    ...
    auto: 'Optimize automatically', long: 'Lengthwise (3 abreast)', broad: 'Crosswise (2 abreast)', visualization: 'Loading space visualization', unit: 'Unit', front: 'Front', empty: 'No pallets to display.',
