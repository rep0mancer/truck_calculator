...
const LANGUAGES = [
  ...
  { code: 'fr', flagSrc: '/flags/fr.svg', label: 'Français' },
  ...
  return (
    <div className="container mx-auto p-4 font-sans space-y-6">
      <header className="relative bg-gradient-to-r from-blue-700 to-blue-900 p-5 rounded-t-lg shadow-lg mb-6 text-slate-100">
        <div className="relative z-10 mt-4 flex flex-wrap justify-center gap-2 xl:absolute xl:right-4 xl:top-3 xl:mt-0 xl:max-w-[34rem] xl:justify-end" role="group" aria-label="Language / Sprache">
